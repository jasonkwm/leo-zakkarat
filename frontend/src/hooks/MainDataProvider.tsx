...
export const MainDataProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    const [tableList, setTableList] = React.useState<string[]>([defaultTable]);
    ...
    const [tableListFull, setTableListFull] = React.useState<string[]>([defaultFullTable]);
